...
\caption[caption]{\textbf{Summary Statistics for Covered California Enrollees}\footnote{Statistics based on the population of households enrolled in a Covered California plan at any point from 2014-2019. Household demographics and income summary statistics are based on all households, while summaries for insurer, metal tier, and network type are conditional on being insured.}}
\centerline{%
