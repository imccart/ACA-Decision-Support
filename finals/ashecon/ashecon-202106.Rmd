...
- Public decision assistance in the form of "navigators"
- Private brokers and agents (majority are brokers)
...
1. Calculate predicted probability of decision assistance from logit model
2. Estimate weighted multinomial logit model among those without any decision assistance, $\hat{\theta}$, with weights $\frac{\hat{p}}{1-\hat{p}}$
