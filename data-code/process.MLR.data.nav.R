# Load Data
	...
	# 2014 Data
	setwd("C:/Users/esaltzm/OneDrive - Emory University/Google Drive/Emory/Research/Navigators/Data/2014 MLR Data")
	...
	ins_data2014 <- read.csv("MR_Submission_Template_Header.csv",header=TRUE)
	ins_data2014$year <- 2014
	ins_data2014 <- ins_data2014[ins_data2014$BUSINESS_STATE == "California",]
	
	finsum_data2014 <- read.csv("Part1_2_Summary_Data_Premium_Claims.csv",header=TRUE)
	finsum_data2014$year <- 2014
	finsum_data2014 <- finsum_data2014[,finsum_to_keep]
	
	mlr_data2014 <- read.csv("Part3_MLR_Rebate_Calculation.csv",header=TRUE)
	mlr_data2014$year <- 2014
	mlr_data2014 <- mlr_data2014[,mlr_to_keep]
	gc()
	
	# 2015 data
	setwd("C:/Users/esaltzm/OneDrive - Emory University/Google Drive/Emory/Research/Navigators/Data/2015 MLR Data")
	
	ins_data2015 <- read.csv("MR_Submission_Template_Header.csv",header=TRUE)
	ins_data2015$year <- 2015
	ins_data2015 <- ins_data2015[ins_data2015$BUSINESS_STATE == "California",]
	
	finsum_data2015 <- read.csv("Part1_2_Summary_Data_Premium_Claims.csv",header=TRUE)
	finsum_data2015$year <- 2015
	finsum_data2015 <- finsum_data2015[,finsum_to_keep]
	
	mlr_data2015 <- read.csv("Part3_MLR_Rebate_Calculation.csv",header=TRUE)
	mlr_data2015$year <- 2015
	mlr_data2015 <- mlr_data2015[,mlr_to_keep]
	gc()
	
	# 2016 data
	setwd("C:/Users/esaltzm/OneDrive - Emory University/Google Drive/Emory/Research/Navigators/Data/2016 MLR Data")
	
	ins_data2016 <- read.csv("MR_Submission_Template_Header.csv",header=TRUE)
	ins_data2016$year <- 2016
	ins_data2016 <- ins_data2016[ins_data2016$BUSINESS_STATE == "California",]
	
	finsum_data2016 <- read.csv("Part1_2_Summary_Data_Premium_Claims.csv",header=TRUE)
	finsum_data2016$year <- 2016
	finsum_data2016 <- finsum_data2016[,finsum_to_keep]
	
	mlr_data2016 <- read.csv("Part3_MLR_Rebate_Calculation.csv",header=TRUE)
	mlr_data2016$year <- 2016
	mlr_data2016 <- mlr_data2016[,mlr_to_keep]
	gc()
	
	# 2017 data
	setwd("C:/Users/esaltzm/OneDrive - Emory University/Google Drive/Emory/Research/Navigators/Data/2017 MLR Data")
	
	ins_data2017 <- read.csv("MR_Submission_Template_Header.csv",header=TRUE)
	...
	finsum_data2017 <- read.csv("Part1_2_Summary_Data_Premium_Claims.csv",header=TRUE)
	...
	mlr_data2017 <- read.csv("Part3_MLR_Rebate_Calculation.csv",header=TRUE)
	...
	# 2018 data
	setwd("C:/Users/esaltzm/OneDrive - Emory University/Google Drive/Emory/Research/Navigators/Data/2018 MLR Data")
	
	ins_data2018 <- read.csv("MR_Submission_Template_Header.csv",header=TRUE)
	...
	finsum_data2018 <- read.csv("Part1_2_Summary_Data_Premium_Claims.csv",header=TRUE)
	...
	mlr_data2018 <- read.csv("Part3_MLR_Rebate_Calculation.csv",header=TRUE)
	...
	ra_reins <- read.csv("ra_reins.csv",header=TRUE)
