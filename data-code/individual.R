...
## Description:   Create individual-level dataset
...
# 4. missing zip3
# 5. missing region
# 6. missing plan info (insurer, metal level)

# drop people with two choices in single year



## Remove antiquated variables
enroll.clean <- enroll.clean %>%
  select(-c(metal_level_enhanced, race_ethnicity, 
