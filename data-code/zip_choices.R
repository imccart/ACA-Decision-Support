...
## Date Edited:   9/22/2020
## Description:   Clean plan-level dataset
## Notes:         Code derived from "make.choice.set.file". This builds a 
##                "long" dataset listing all of the plan offerings by
##                3-digit zip codes, region, and year.
